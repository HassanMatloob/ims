...
<div class="container-fluid">
    ...
    @if( isset($indigent) )
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="media d-sm-flex d-block text-center text-sm-left">
                    ...
                    <div class="media-body align-items-right">
                        <span class="d-block text-light mb-2">ID Number</span>
                        <p class="fs-18 text-dark font-w600 mb-0">{{$indigent->id_number}}</p>
                    </div>
                </div>
            </div>            
        </div>
        ...
        @if(isset($pd))
            <div class="card">
                <div class="card-header border-0 pb-0">
                <h4 class="fs-20 font-w600 text-dark">Personal Details</h4>
                <a href="{{route('user.personalDetails.editPD', ['id' => $indigent->id])}}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip1)">
                    <path d="M22.4455 1.55474C20.3795 -0.516293 17.0199 -0.516293 14.9539 1.55474L1.21862 15.2849C1.11124 15.3923 1.04476 15.5304 1.0243 15.6787L0.00668299 23.2162C-0.023999 23.431 0.052706 23.6458 0.201002 23.7941C0.328844 23.9219 0.507822 23.9986 0.686801 23.9986C0.717483 23.9986 0.748165 23.9986 0.778847 23.9935L5.31978 23.3798C5.6982 23.3287 5.96411 22.981 5.91297 22.6026C5.86183 22.2242 5.5141 21.9583 5.13569 22.0094L1.49476 22.5003L2.20556 17.2435L7.73855 22.7764C7.86639 22.9043 8.04537 22.981 8.22435 22.981C8.40333 22.981 8.5823 22.9094 8.71015 22.7764L22.4455 9.04625C23.4477 8.04398 24 6.71442 24 5.29794C24 3.88146 23.4477 2.5519 22.4455 1.55474ZM15.2198 3.24225L17.5261 5.54851L4.99251 18.0821L2.68624 15.7758L15.2198 3.24225ZM8.22946 21.3139L5.97433 19.0588L18.5079 6.52522L20.7631 8.78034L8.22946 21.3139ZM21.7244 7.79341L16.2068 2.27577C16.9074 1.69792 17.7818 1.38088 18.7023 1.38088C19.7506 1.38088 20.7324 1.78997 21.4739 2.52634C22.2153 3.2627 22.6193 4.24964 22.6193 5.29794C22.6193 6.22351 22.3023 7.09284 21.7244 7.79341Z" fill="black"/>
                    </g>
                ...
                <div class="card-body">
                    <div class="row pb-4 mb-4 border-bottom">
                        <div class="col-lg-6 mb-3">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <span class="d-block text-light mb-2">Residential Address</span>
                        ...
                        <div class="col-lg-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <span class="d-block text-light mb-2">Postal Address</span>
                                    <p class="fs-18 text-dark">
                                        {{$pd->postal_address}}, <strong>{{$pd->postal_code}}</strong>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mt-3 mb-md-0 mb-3">
                            <div class="media">
                                <span class="p-3 border border-primary-light rounded-circle mr-3">
                                    <svg width="22" height="22" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M28.2884 21.7563V25.6138C28.2898 25.9719 28.2165 26.3264 28.073 26.6545C27.9296 26.9826 27.7191 27.2771 27.4553 27.5192C27.1914 27.7613 26.8798 27.9456 26.5406 28.0604C26.2014 28.1751 25.8419 28.2177 25.4853 28.1855C21.5285 27.7555 17.7278 26.4035 14.3885 24.238C11.2817 22.2638 8.64771 19.6297 6.67352 16.523C4.50043 13.1685 3.14808 9.34928 2.72601 5.37477C2.69388 5.0192 2.73614 4.66083 2.8501 4.32248C2.96405 3.98413 3.14721 3.67322 3.38792 3.40953C3.62862 3.14585 3.92159 2.93517 4.24817 2.79092C4.57475 2.64667 4.9278 2.57199 5.28482 2.57166H9.14232C9.76634 2.56552 10.3713 2.78649 10.8445 3.1934C11.3176 3.60031 11.6267 4.16538 11.714 4.78329C11.8768 6.01778 12.1788 7.22988 12.6141 8.39648C12.7871 8.85671 12.8245 9.35689 12.722 9.83775C12.6194 10.3186 12.3812 10.76 12.0354 11.1096L10.4024 12.7426C12.2329 15.9617 14.8983 18.6271 18.1174 20.4576L19.7504 18.8246C20.1001 18.4789 20.5414 18.2406 21.0223 18.1381C21.5031 18.0355 22.0033 18.073 22.4636 18.246C23.6302 18.6813 24.8423 18.9832 26.0767 19.1461C26.7014 19.2342 27.2718 19.5488 27.6796 20.0301C28.0874 20.5113 28.304 21.1257 28.2884 21.7563Z" stroke="#2BC155" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="fs-18 text-dark font-w600 mb-0">{{$pd->erf}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-3 mb-md-0 mb-3">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <span class="d-block text-light mb-2">WARD</span>
                                    <p class="fs-18 text-dark font-w600 mb-0">{{$pd->ward_number}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="javascript:void(0);" class="btn bgl-primary btn-rounded text-black mb-2 mr-2">
                    @if($pd->employment_status == "Employed")
                    ...
                    Employed
                    @elseif($pd->employment_status == "Unemployed")
        ...
        @else
            <div class="card">
                <div class="card-body">
                    <p class="d-block text-light mb-2">No Personal Details yet.</p>
                    <a class="btn btn-secondary" href="{{route('user.personalDetails.createPersonalDetails')}}">
                        Take me there
                    </a>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="example5" class="table table-striped patient-list mb-4 dataTablesCard fs-14">
                                ...
                                <tbody>
                                    @foreach($houseCash as $hc)
                                    <tr>
                                        <td>{{$hc->full_name}}</td>
                                        <td>{{$hc->relationship}}</td>
                                        <td>{{$hc->gender}}</td>
                                        <td>{{$hc->date_of_birth}}</td>
                                        <td>R{{$hc->total_income}}</td>
                                        <td>
                                            <a href="#">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        @else
            <div class="card">
                <div class="card-body">
                    <p class="d-block text-light mb-2">No Income Details yet.</p>
                    <a class="btn btn-secondary" href="{{route('user.householdIncomes.create')}}">
                        Take me there
                    </a>
                </div>
                ...
                <div class="card-body">
                    <div class="col-lg-6 mb-3">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span class="d-block text-light mb-2">Source of Main Water</span>
                                <p class="fs-18 text-dark">{{$house->main_water_src}}</strong></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span class="d-block text-light mb-2">Toilet Facility</span>
                                <p class="fs-18 text-dark">{{$house->toilet_facility}}</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @else
            <div class="card">
                <div class="card-body">
                    <p class="d-block text-light mb-2">No Household Conditions yet.</p>
                    <a class="btn btn-secondary" href="{{route('user.householdConditions.create')}}">
                        Take me there
                    </a>
                </div>
        ...
        @else
                <p class="d-block text-light mb-2">No Documents uploaded yet.</p>
                <a class="btn btn-secondary" href="{{route('user.documents.create')}}">
                    Take me there
                </a>
        @endif
            </div>
        ...
        <form action="{{route("user.indigencies.confirm", ["id" => $indigent->id])}}" method="POST">
            @csrf
            @method("PUT")
           <button type="submit" class="btn btn-secondary">Confirm and Submit</button> 
        </form>
        
        @else
        <a href="javascript:void(0)" class="btn btn-secondary">Confirm and Submit</a>
        @endif
    @else
        <div class="form-head d-flex mb-3 mb-md-4 align-items start">
            <div class="mr-auto d-done d-lg-block">
                <h3 class="text-black font-w600">
                    Welcome to Hello World Indigent Application Platform!
                </h3>
            </div>
        </div>
        <a class="btn btn-secondary" href="{{route('user.indigencies.create')}}">
            let's get started
        </a>
