						...
						@else
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
                                    @if(isset($profile))
                                    <img src="{{ asset('storage/pro_photos/'. $profile->pro_pic) }}" width="20" alt=""/>
                                    <div class="header-info">
                                        <span><strong>{{$profile->fname}}</strong></span>
                                    </div>
                                    @else
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('admin.profiles.index') }}" class="dropdown-item ai-icon">
