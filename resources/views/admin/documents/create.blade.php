...
@section('content')
	<div class="container-fluid">
		<form method="POST" action="{{ route('admin.documents.store') }}" enctype="multipart/form-data" file=true>
		@csrf
		...
		<div class="form-group row">
			<label for="physical-form" class="col-md-4 col-form-label text-md-right">Physical Application Form</label>
			<div class="col-md-6">
				<input id="physical-form" name="phys_form" type="file" class="form-control" />
			</div>
		</div>

		<input style="display: none;" type="number" name="indigent_id" value="{{$indigent->id}}" readonly />
