...
@section('content')
	...
	<div class="container-fluid">
		...
		<form method="POST" action="{{ route('admin.indigencies.store') }}" enctype="multipart/form-data" file=true>
			@csrf
			...
			<div class="form-group row">
				<label for="id_no" class="col-md-4 col-form-label text-md-right">ID Number</label>
				<div class="col-md-6">
					<input id="id_no" name="id_no" type="text" class="form-control" required />
				</div>
			</div>
