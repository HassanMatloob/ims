...
<div class="container-fluid">
	...
	<form method="POST" action="{{ route('admin.personalDetails.storeEmploymentDetails') }}">
		@csrf
			...
			<div class="col-md-6">
				<input id="indigent_id" type="number" name="indigent_id" class="form-control" value="{{$indigent->id}}" readonly required />
			</div>
		</div>
		<div class="form-group row mb-0">
			<div class="col-md-6 offset-md-4">
				<a type="button" href="{{route('admin.personalDetails.createPersonalDetails', ["id" => $indigent->id])}}" class="btn btn-warning">Previous</a>
